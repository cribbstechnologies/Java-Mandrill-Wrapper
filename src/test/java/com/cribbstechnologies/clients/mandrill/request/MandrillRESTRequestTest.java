...
public class MandrillRESTRequestTest {
	...
	public void testGetPostDataIOException() throws Exception {
		...
		Mockito.when(this.mapper.writeValueAsString(this.emptyBaseRequest)).thenThrow(new IOException("Mockito!"));
		try {
	...
	public void testListTagsResponseConversion() throws IOException {
		...
		BaseMandrillAnonymousListResponse<BaseTag> response = (BaseMandrillAnonymousListResponse<BaseTag>) this.request.convertAnonymousListResponseData(
				sw.toString(), TagListResponse.class, tagListReference);
	...
	public void testSendersResponseConversion() throws IOException {
		...
		BaseMandrillAnonymousListResponse<MandrillSender> response = (BaseMandrillAnonymousListResponse<MandrillSender>) this.request
				.convertAnonymousListResponseData(sw.toString(), UsersSendersResponse.class, usersListReference);
	...
	public void testSendMessageResponseConversion() throws IOException {
		...
		BaseMandrillAnonymousListResponse<MessageResponse> response = (BaseMandrillAnonymousListResponse<MessageResponse>) this.request
				.convertAnonymousListResponseData(sw.toString(), SendMessageResponse.class, responseListReference);
	...
	public void testTemplateListResponseConversion() throws IOException {
		...
		BaseMandrillAnonymousListResponse<TemplateResponse> response = (BaseMandrillAnonymousListResponse<TemplateResponse>) this.request
				.convertAnonymousListResponseData(sw.toString(), TemplateResponse.class, templatesListReference);
	...
	public void testTimeTagsResponseConversion() throws IOException {
		...
		BaseMandrillAnonymousListResponse<TagWithTime> response = (BaseMandrillAnonymousListResponse<TagWithTime>) this.request
				.convertAnonymousListResponseData(sw.toString(), TagSeriesResponse.class, tagListReference);
	...
	public void testUrlListResponseConversion() throws IOException {
		...
		BaseMandrillAnonymousListResponse<UrlResponse> response = (BaseMandrillAnonymousListResponse<UrlResponse>) this.request
				.convertAnonymousListResponseData(sw.toString(), UrlListResponse.class, urlListReference);
	...
	public void testUrlTimeResponseConversion() throws IOException {
		...
		BaseMandrillAnonymousListResponse<TimeUrlResponse> response = (BaseMandrillAnonymousListResponse<TimeUrlResponse>) this.request
				.convertAnonymousListResponseData(sw.toString(), UrlTimeResponse.class, urlTimeReference);
